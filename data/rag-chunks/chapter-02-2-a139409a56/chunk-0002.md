---
chunk_id: "chapter-02-2-a139409a56-chunk-0002"
...
• the artifacts (object made by a human being)  have significant computational 
resources 
...
• “right thing”?
• Consequentialism: we evaluate an agent’s behavior by its 
consequences. 
• When an agent is put down in an environment, it generates a sequence of 
...
• the performance measure is, initially at least, in the mind of the designer of 
the machine, 
...
according to what one actually wants to be achieved in the 
environment, rather than according to how one thinks the agent 
should behave.
14
