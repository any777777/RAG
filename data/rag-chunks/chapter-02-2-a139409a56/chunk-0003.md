---
chunk_id: "chapter-02-2-a139409a56-chunk-0003"
...
• The Right and Left actions move the agent one square except when this would take the agent 
...
16
… Rationality
Under these circumstances the agent is indeed rational; its expected performance is at least as good as any 
other agent’s.

## Page 17

Irrational case
• One can see easily that the same agent would be irrational 
...
each movement, the agent will fare poorly. 
• A better agent for this case would do nothing once it is sure that 
...
• An omniscient (كلي المعرفة) agent knows the actual outcome of its 
...
information gathering—is an important part of rationality and is 
covered in depth in Chapter 15.
• A second example of information gathering is provided by the exploration
that must be undertaken by a vacuum-cleaning agent in an initially unknown 
environment.
18
