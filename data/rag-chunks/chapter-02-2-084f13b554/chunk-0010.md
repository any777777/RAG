---
chunk_id: "chapter-02-2-084f13b554-chunk-0010"
...
A performance measure assigns a score to any given sequence of environment states: (google map).
...
Example: An autonomous vehicle selecting a route that optimizes safety, speed, and fuel efficiency, balancing competing factors.
...
Selects actions that maximize expected utility allowing trade-offs between conflicting goals.
...
In two kinds of cases, goals are inadequate (insufficient for a purpose), but a utility-based agent can still make rational decisions:
...
utility agent  provides a way in which the likelihood of success can be weighed against the importance of the goals.
